...
public class LunchActivity extends AppCompatActivity  {
    ...
    GridView gridView;  //
    ArrayList<Lunch> list;  //
    LunchListAdapter adapter = null;  //
    ...
    protected void onCreate(@Nullable Bundle savedInstancestate) {
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(edtdate.getText().toString().isEmpty())
                {
                    ...
                    sqLiteHelper.insertLunch(selecteditem, edtdate.getText().toString());

                    Toast.makeText(com.example.android.details.Lunch.LunchActivity.this, "Saved successfully!", Toast.LENGTH_SHORT).show();
        ...
        sqLiteHelper.queryData("CREATE TABLE IF NOT EXISTS FOOD1(Id INTEGER PRIMARY KEY AUTOINCREMENT, name VARCHAR, image shortBLOB)");

        sqLiteHelper.queryData("CREATE TABLE IF NOT EXISTS LUNCH(Id INTEGER PRIMARY KEY AUTOINCREMENT, name VARCHAR, date VARCHAR)");
     ...
     /*   fam.setOnClickListener(new View.OnClickListener() {
        ...
        fabView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Cursor b = sqLiteHelper.getLunch();
                ...
                showMessage("Lunch", buffer.toString());
...
//        final FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab);
    ...
    private void displayInputdialog ( final int pos) {
        ...
        btnChoose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(com.example.android.details.Lunch.LunchActivity.this);
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        if (item == 0) {
                            ...
                            ActivityCompat.requestPermissions
                                    (com.example.android.details.Lunch.LunchActivity.this,
                            ...
                            ActivityCompat.requestPermissions(com.example.android.details.Lunch.LunchActivity.this,
    ...
    public void list() {
        ...
        list = new ArrayList<>();
        adapter = new LunchListAdapter(this, R.layout.lunch_items,list);
        gridView.setAdapter(adapter);

        // get all data from sqlite

        final Cursor cursor = com.example.android.details.Lunch.LunchActivity.sqLiteHelper.getData("SELECT * FROM FOOD1");
        list.clear();
        ...
        while (cursor.moveToNext()) {
            ...
            list.add(new Lunch(name, image, id));
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                final Cursor cursor1= com.example.android.details.Lunch.LunchActivity.sqLiteHelper.getData("SELECT * FROM FOOD1");
